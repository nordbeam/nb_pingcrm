  ...
  defp deps do
    [
      ...
      {:nb_inertia,
       ...
       ref: "eb831679af5c1a3ff55ae747a7972069fc78e5ca",
       override: true},
      {:nb_routes,
      ...
      {:nb_serializer,
       ...
       ref: "ba51f39beb27f4f77b67c61198f6d81c647fbe32",
       override: true},
      {:nb_ts,
       github: "nordbeam/nb_ts", ref: "0ed21698e550ac37ea3de91a2a5ec2fd3cafef77", override: true},
      {:nb_flop,
